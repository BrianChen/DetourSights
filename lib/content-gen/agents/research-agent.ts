...
${config.configurable.country}`
  ...
  console.log(`  what research llm read: `, result.messages);
  console.log(`  [research] done`)
  console.log(`  researchNotes: `, result.structuredResponse.researchNotes);
  console.log(`  researchSources: `, result.structuredResponse.researchSources);
