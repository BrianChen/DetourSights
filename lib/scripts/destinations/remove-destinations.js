 ...
 *
 * After running: manually remove the same destinations and their places from
 * prisma/seed.js so the seed stays in sync.
 */
...
async function main() {
  ...
  if (DRY_RUN) {
    ...
    console.log('Remember to also remove these entries from prisma/seed.js.');
  } else {
    console.log('\n─── Done. Remember to remove these entries from prisma/seed.js. ───');
  }
}
